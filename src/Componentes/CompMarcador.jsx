...
export const CompMarcador = ({ nombre1, marcador1, nombre2, marcador2, round, textoParr1, setTextoParrafo1 }) => {
    return (
        <div className="claseContMarcador">
            ...
            <section className="claseContMarcadorParrafo ">
                <DisplayParrafo1 textoParrafo1={textoParr1} setTextoParrafo1={setTextoParrafo1} nombre={nombre1}/>
            </section>
        </div>
    )
}
